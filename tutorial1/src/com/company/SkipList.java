...
public class SkipList<E extends Comparable<E>> extends AbstractSortedSet<E> {
    ...
    public SkipList() {
        ...
        head = new SkipListNode<E>(null, maxLevel);
        // null marks the end
        head.nextNodes.add(null);
        System.out.println(head.nextNodes.size());
    }

//    public SkipList(SkipListNode<E> head) {
//        this.head = head;
//        this.maxLevel = 0;
//        this.size = 0;
//    }
...
//            maxLevel++;
//        }
        SkipListNode newNode = new SkipListNode<E>(e, level+1);
        SkipListNode current = head;
        do {
            current = findNext(e,current,level);
            newNode.nextNodes.set(level,current.nextNodes.get(level));
